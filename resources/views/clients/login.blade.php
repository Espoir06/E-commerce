                ...
                <div class="login">
                    ...
                    <form action="{{ route('login.script') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <button class="btn color_1_bg mt-3" name="user_register">Login</button>
                            </div>
                            <a class="text-info" href="{{route('register.clients')}}">Creez un compte</a>
                            <a class="text-info" href="{{route('prop.connect.page')}}">Vous etes proprio ?</a>
                        </div>
                    </form>
                </div>
            </div>
